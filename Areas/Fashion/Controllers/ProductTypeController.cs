...
namespace Hope.BackendServices.API.Areas.Fashion.Controllers
{
    ...
    [ApiController]
    [Authorize]
    public class ProductTypeController : ReferenceDataControllerBase<ProductType, ProductTypeDetails>
    {
        private readonly IProductTypeService _productTypeService;

        public ProductTypeController(IProductTypeService productTypeService, IMapper mapper)
           : base(productTypeService, mapper)
        {
            _productTypeService = productTypeService;
        }

        [HttpPost]
        public async Task<IActionResult> Post([FromBody] ProductTypeDetails details)
        {
            return await CreateEntity(details);
        }

        [HttpPut]
        public async Task<IActionResult> Put([FromBody] ProductTypeDetails details)
        {
